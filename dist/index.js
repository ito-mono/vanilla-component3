...
Check the top-level render call using <` + a + ">.");
      ...
      v.Children = $t, v.Component = _, v.Fragment = re, v.Profiler = Q, v.PureComponent = W, v.StrictMode = te, v.Suspense = V, v.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = U, v.cloneElement = It, v.createContext = ur, v.createElement = Dt, v.createFactory = Ft, v.createRef = hr, v.forwardRef = kr, v.isValidElement = ge, v.lazy = Pr, v.memo = c, v.startTransition = jt, v.unstable_act = xt, v.useCallback = J, v.useContext = R, v.useDebugValue = ie, v.useDeferredValue = yt, v.useEffect = Y, v.useId = ht, v.useImperativeHandle = ir, v.useInsertionEffect = x, v.useLayoutEffect = F, v.useMemo = be, v.useReducer = b, v.useRef = m, v.useState = S, v.useSyncExternalStore = mt, v.useTransition = vt, v.version = Ee, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
    }();
...
function Ut() {
  if (lt)
    return He;
  lt = 1;
  var z = pt(), v = Symbol.for("react.element"), Ee = Symbol.for("react.fragment"), X = Object.prototype.hasOwnProperty, de = z.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, re = { key: !0, ref: !0, __self: !0, __source: !0 };
  function te(Q, $, Z) {
    ...
    if (Q && Q.defaultProps)
      for (L in $ = Q.defaultProps, $)
        V[L] === void 0 && (V[L] = $[L]);
    return { $$typeof: v, type: Q, key: ee, ref: G, props: V, _owner: de.current };
  }
...
var Bt = Nr.exports;
function zt({ children: z, ...v }) {
  return /* @__PURE__ */ Bt.jsx("button", { ...v, children: z });
}
export {
  zt as Button
};
